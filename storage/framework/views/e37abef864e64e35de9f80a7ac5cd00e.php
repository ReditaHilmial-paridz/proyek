...
<div class="container mt-4">
    ...
    <div class="mb-3">
        ...
        <form action="<?php echo e(route('petugas.template')); ?>" method="GET" style="display: inline;">
        </form>
    </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody id="petugasTableBody">
                ...
                <tr id="row_<?php echo e($item->id); ?>">
                    <td data-label="ID"><?php echo e($loop->iteration); ?></td>
                    ...
                    <td data-label="Action">
                        <button class="btn btn-primary btn-sm me-1 edit-btn" 
                                ...
                                data-jabatan="<?php echo e($item->jabatan); ?>"
                                data-kontak="<?php echo e($item->kontak); ?>"
                                data-email="<?php echo e($item->email); ?>"
                                data-bs-toggle="modal" 
                                data-bs-target="#editPetugasModal">✏️</button>
                        <button class="btn btn-danger btn-sm delete-btn" data-id="<?php echo e($item->id); ?>">🗑️</button>
                    </td>
                </tr>
    ...
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addPetugasForm" action="<?php echo e(route('petugas.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
