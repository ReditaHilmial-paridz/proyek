...
<div class="container mt-4">
    ...
    <form action="<?php echo e(route('fasilitas.index')); ?>" method="GET" id="searchForm">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <input type="text" name="search" class="form-control w-25" placeholder="Search..." value="<?php echo e(request('search')); ?>" />
    ...
    <div class="modal fade" id="tambahFasilitasModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="fasilitasForm" action="<?php echo e(route('fasilitas.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm">
                <img src="<?php echo e(asset($item->gambar)); ?>" class="card-img-top img-fluid" alt="Gambar Fasilitas" style="height: 200px; object-fit: cover;">
                <div class="card-body">
                    <h5 class="card-title fw-bold"><?php echo e($item->nama); ?></h5>
                    <p class="mb-1"><strong>Kategori:</strong> <?php echo e($item->kategori); ?></p>
                    <p class="mb-1"><strong>Kondisi:</strong> <?php echo e($item->kondisi); ?></p>
                    <p class="mb-1"><strong>Lokasi:</strong> <?php echo e($item->lokasi); ?></p>
                    <p class="mb-1"><strong>Deskripsi:</strong> <?php echo e($item->deskripsi); ?></p>
                    <div class="d-flex justify-content-end gap-2">
                    <button class="btn btn-warning btn-sm edit-btn" data-id="<?php echo e($item->id); ?>" data-bs-toggle="modal" data-bs-target="#editFasilitasModal">
                        <i class="bi bi-pencil"></i>
                    </button>
                        <form action="<?php echo e(route('fasilitas.destroy', $item->id)); ?>" method="POST" class="d-inline">
                            <?php echo csrf_field(); ?>
